...
m<sup>6</sup>A-reg-exp genes, their associated regulatory mode and strength <script type="text/javascript" src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=default"></script> \beta<sub>1</sub>, the methylation intensities, and the gene expression levels.  
